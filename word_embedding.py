# -*- coding: utf-8 -*-
"""
Created on Thu Mar 25 22:21:51 2021
...
for line in redir:
    try:
        ...
        print("exception")
        continue
    if "Microsoft Office" in line[0]: 3
        b=1
        print("OK")
    else : 
        b=0
...
w2v = gensim.models.word2vec.Word2Vec(sentences=sentenceses,size=100, window=5, min_count=0, workers=32, sg=0)
print(w2v.wv.most_similar("C:\\Program Files\\Microsoft Office\\Root\\Office16\\WINWORD.EXE"))
sentences=vectorizer.fit(sentenceses)
model = Word2Vec(sentences, 50000)
